...
لتعريب رسائل البريد الإلكتروني المرسلة من Firebase (مثل تغيير البريد، تفعيل المصادقة الثنائية)، اذهب إلى **Authentication** -> **Templates** في Firebase Console واستخدم النصوص التالية:

### 1. تغيير عنوان البريد الإلكتروني (Email address change)

**الموضوع (Subject):**
```text
"%APP_NAME%" تم تغيير عنوان بريدك الإلكتروني لتسجيل الدخول إلى
```
...
تم تغيير عنوان بريدك الإلكتروني لتسجيل الدخول إلى "%APP_NAME%" وأصبح "%NEW_EMAIL%".

إذا لم يكن طلب تغيير عنوان البريد الإلكتروني لتسجيل الدخول صادرًا عنك، يُرجى اتباع الرابط التالي لإعادة ضبطه
...
### 2. إشعار تفعيل المصادقة الثنائية (Multi-factor enrollment notification)

**الموضوع (Subject):**
```text
"%APP_NAME%" تم تفعيل المصادقة الثنائية لحسابك في
```
...
تم تفعيل المصادقة الثنائية (Multi-factor Authentication) لحسابك في "%APP_NAME%".

إذا لم تقم بهذا الإجراء، يُرجى تأمين حسابك فوراً أو الاتصال بالدعم الفني.
...
> **ملاحظة:** تأكد من استبدال `%APP_NAME%` و `%DISPLAY_NAME%` و `%LINK%` هي متغيرات يقوم Firebase باستبدالها تلقائياً بالقيم الحقيقية.
